...
$user_id = Yii::$app->user->identity->id;
	...
	$iconother = '<i class="fe fe-user text-primary" data-toggle="tooltip" data-original-title="Входящее"></i>';
...
if ($model->from_id == $user_id) {
	...
	$answer = '<i class="fe fe-corner-up-right" data-toggle="tooltip" data-original-title=""></i> <a href="#" data-to="'.$model->from_id.'" data-to-name="'.$model->from_name.'" data-target="newmsg">Ответить</a>&nbsp;&nbsp;&nbsp;<i class="fe fe-mail"></i> <a href="#">Диалог</a>';
	$toname = '';
}
*/
?>

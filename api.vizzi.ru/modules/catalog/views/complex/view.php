...
use app\models\Jk;
use app\models\Zastroi;
use app\models\Liters;
use app\models\Sections;
use app\models\SectionFlat;
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cart-content__info">
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt40 mb40">
		<span class="balls"><?php echo $jk_obj->c_rating; ?></span> <span class="cart-title-txt"><?php echo $jk_obj->c_name; ?></span>
		<div class="rating-stars">
		<?php switch($jk_obj->c_rating) {
		case '1': echo '<img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" class="gray" /> <img src="/img/icons/cart/star.png" class="gray" /> <img src="/img/icons/cart/star.png" class="gray" /> <img src="/img/icons/cart/star.png" class="gray" />'; break;
		case '2': echo '<img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" />  <img src="/img/icons/cart/star.png" class="gray" />  <img src="/img/icons/cart/star.png" class="gray" />  <img src="/img/icons/cart/star.png" class="gray" />'; break;
		case '3': echo '<img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" />  <img src="/img/icons/cart/star.png" class="gray" />  <img src="/img/icons/cart/star.png" class="gray" />'; break;
		case '4': echo '<img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" />  <img src="/img/icons/cart/star.png" class="gray" />'; break;
		case '5': echo '<img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" /> <img src="/img/icons/cart/star.png" />'; break;
		} ?>
		</div>
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt50 mb40">
		...
		<?php $zastroi = Zastroi::find()->where(['id' => $jk_obj->b_id])->one(); ?>
		<div class="mb20"><img src="/img/icons/cart/stroy.png" /> <b>Застройщик</b> <span><?php echo $zastroi->b_name; ?></span></div>
	</div>
...
<?php
//$liters = Liters::find()->where(['jk_id'=>$id])->one();
//$sections = Sections::find()->where(['lit_id'=>$liters->id])->one();



$query = SectionFlat::find()->where(['sec_id'=>'1'])->orderBy('id DESC');
